...
SECRET_KEY = 'django-insecure-r(ri-ph%p@#csr)lot9y6(5dgeud*e7nwxezlt4h0ms-$@6zbf'
...
# Authentication backends: include default plus custom backend for fittracker.User
